...
(function (Luftfahrt) {
    ...
    function bees() {
        for (let bee = 0; bee < 8; bee++) {
            ...
            let minYBee = 250;
            //position
            let randomXBee = Math.floor(Math.random() * (maxXBee - minXBee)) + minXBee;
            let randomYBee = Math.floor(Math.random() * (maxYBee - minYBee)) + minYBee;
            //Body
            crc2.beginPath();
    ...
    function clouds() {
        for (let cloud = 0; cloud < 3; cloud++) {
            ...
            let minYCloud = 250;
            //position
            let randomXCloud = Math.floor(Math.random() * (maxXCloud - minXCloud)) + minXCloud;
            let randomYCloud = Math.floor(Math.random() * (maxYCloud - minYCloud)) + minYCloud;
            crc2.beginPath();
